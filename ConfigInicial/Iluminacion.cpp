...
glm::vec3 lightPos2(-3.0f, 3.0f, -2.0f);
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light2.ambient"), 1.1f, 1.1f, 1.3f);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light2.diffuse"), 1.2f, 1.2f, 1.7f);
